...
<div class="SdvQLc cmodal md-effect-3" id="slidein" align="center">
<div class="content">
<div id="question">
</div>
<center>
...
$("#question").load("content/a4bdfba5726b73c377b0bd76a810681c.txt");
...
var values="answer="+answer;
	$.ajax({
                ...
                success: function(data, status){
                	...
                	{
                		FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 6 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
