<?php
    ...
    if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level54.php')
    {
...
<button id="redirect">Try Again</button>
            ...
            <nav class="outer-nav top horizontal" style="transition:all 2s;">
                ...
                <a href="#!/page_Contact_has_clues_sagfiufas/sb3dnfh4js" class="md-trigger" data-modal="modal-7"><img class="mbutton" src="img/contactg.png" alt="Contact"/></a>
...
$("#question").load("content/8c1cc8141bc4b201067d4f9050b33128.txt");
...
var values="answer="+answer;
    $.ajax({
                ...
                success: function(data, status){
                    ...
                    {
                        FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 55 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
