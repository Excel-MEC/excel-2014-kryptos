...
<div class="pPuV8hK cmodal md-effect-3" id="slidein" align="center">
<div class="content">
<div id="question">
...
$("#question").load("content/965cc19be9d910ff6ed9b1843ff5985e.txt");
...
var values="answer="+answer;
	$.ajax({
                ...
                success: function(data, status){
                	...
                	{
                		FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 16 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
