<?php
    ...
    if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level44.php')
    {
...
$("#question").load("content/uhff0owa0doauztvsh6raixtobu99s.txt");
...
var values="answer="+answer;
    $.ajax({
                ...
                success: function(data, status){
                    ...
                    {
                        FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 45 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
