...
<div class="hGld1ma6 cmodal md-effect-3" id="slidein" align="center">
<div class="content">
<div id="question">
</div>
<center>
...
$("#question").load("content/a47d53497d3f0b4599b874bbe746c55b.txt");
...
var values="answer="+answer;
	$.ajax({
                ...
                success: function(data, status){
                	...
                	{
                		FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 23 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
