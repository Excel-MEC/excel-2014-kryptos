<?php
    ...
    if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level40.php')
    {
...
<button id="redirect">Try Again</button>
            ...
            <nav class="outer-nav top horizontal" style="transition:all 2s;">
                ...
                <a href="#!/page_Rules_has_clues_a=4d=4 l=33" class="md-trigger" data-modal="modal-11"><img class="mbutton" src="img/rulesg.png" alt="Rules"/></a>
...
$("#question").load("content/adseirds3haumhxnc9z99bah0dsbk7.txt");
...
var values="answer="+answer;
    $.ajax({
                ...
                success: function(data, status){
                    ...
                    {
                        FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 41 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
