...
$("#question").load("content/0aaa6569fc0153282fbc2059b3adb8b4.txt");
...
var values="answer="+answer;
    $.ajax({
                ...
                success: function(data, status){
                    ...
                    {
                        FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 35 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
