...
<div class=" cmodal md-effect-3" id="slidein" align="center">
<div class="content">
<div id="question">
</div>
<center>
...
$("#question").load("content/147eeb629e5bf953ada5ef89e0c50ffb.txt");
...
var values="answer="+answer;
    $.ajax({
                ...
                success: function(data, status){
                    ...
                    {
                        FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 36 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
