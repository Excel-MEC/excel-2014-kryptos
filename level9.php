...
<div class="qSkRBJ cmodal md-effect-3" id="slidein" align="center">
<div class="content" style="background-color:rgba(0,0,0,0) !important; border:none !important;">
<div id="question">
</div>
<div class="progress-button" style="position:relative;top:-64px;">
...
$("#question").load("content/da0b5fff60e60f67d3a72a4d2b6fc3ea.txt");

$("#submitter").click(function(){

var a = document.getElementById("br1").parentNode;
		var answer_c = a.className;
		var a = document.getElementById("bk").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("wk").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("wr1").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("bh1").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("wq").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("wh1").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("bb1").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("wp4").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("bq").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("wb1").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("wp2").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("bp1").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("wp1").parentNode;
		answer_c = answer_c + a.className;
		var a = document.getElementById("wp3").parentNode;
		answer_c = answer_c + a.className;
...
var values="answer="+answer_c;
	$.ajax({
                ...
                success: function(data, status){
                	...
                	{
                		//FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 10 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
