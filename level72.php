<?php
    ...
    if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level72.php')
    {
...
<button id="redirect">Try Again</button>
            ...
            <nav class="outer-nav top horizontal" style="transition:all 2s;">
                ...
                <a href="#!/page_Rules_has_clues_Remember_that_day" class="md-trigger" data-modal="modal-11"><img class="mbutton" src="img/rulesg.png" alt="Rules"/></a>
                <a href="#!/page_Contact_has_clues_Remember_that_day" class="md-trigger" data-modal="modal-7"><img class="mbutton" src="img/contactg.png" alt="Contact"/></a>
...
$("#question").load("content/f66d104a552b61dc09e4572c9bde0e62.txt");

$("#submitter").click(function(){
var answer=document.getElementById("answer").value;
var values=value+"answer="+answer;
    $.ajax({
                type:"POST",
                url: 'ans.php',
                data: values,
                success: function(data, status){
                    ...
                    {
                        FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 73 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
