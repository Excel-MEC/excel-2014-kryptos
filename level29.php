...
$("#question").load("content/ad849fb47acd4e7cb4fffa7276120ba6.txt");
...
var values="answer="+answer;
	$.ajax({
                ...
                success: function(data, status){
                	...
                	{
                		FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 30 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
