<?php
    ...
    if(!isset($_SESSION['usrno']) || $_SESSION['lev']!='level61.php')
    {
...
<button id="redirect">Try Again</button>
            ...
            <nav class="outer-nav top horizontal" style="transition:all 2s;">
                ...
                <a href="#!/page_Rules_has_clues_kiuxiqov" class="md-trigger" data-modal="modal-11"><img class="mbutton" src="img/rulesg.png" alt="Rules"/></a>
...
$("#question").load("content/81a6ed25e2af298131271869c4573d68.txt");
...
var values="answer="+answer;
    $.ajax({
                ...
                success: function(data, status){
                    ...
                    {
                        FB.api('/me/feed', 'post', {caption: "Online Treasure Hunt: Excel2014", message: 'I Just unlocked Level 62 of Kryptos! Can you do better? Prizes worth 45K!!!', link: 'http://kryptos.excelmec.org', name: "Kryptos", picture: "http://kryptos.excelmec.org/images/favicon.png.pagespeed.ce.YLmIxTciuu.png"});
